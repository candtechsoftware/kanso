...
internal OS_Handle
os_window_open(OS_Window_Flags flags, Vec2<s64> size, String title);
internal void
os_window_close(OS_Handle handle);
internal void
os_window_set_title(OS_Handle handle, String title);
internal void
os_window_set_icon(OS_Handle handle, Vec2<s32> size, String rgba_data);
internal void
