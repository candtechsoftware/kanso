...
os_string_from_key(OS_Key key)
{
    ...
    switch(key)
    {
        case OS_Key_A: result = str_lit("A"); break;
        case OS_Key_B: result = str_lit("B"); break;
        case OS_Key_C: result = str_lit("C"); break;
        case OS_Key_D: result = str_lit("D"); break;
        case OS_Key_E: result = str_lit("E"); break;
        case OS_Key_F: result = str_lit("F"); break;
        case OS_Key_G: result = str_lit("G"); break;
        case OS_Key_H: result = str_lit("H"); break;
        case OS_Key_I: result = str_lit("I"); break;
        case OS_Key_J: result = str_lit("J"); break;
        case OS_Key_K: result = str_lit("K"); break;
        case OS_Key_L: result = str_lit("L"); break;
        case OS_Key_M: result = str_lit("M"); break;
        case OS_Key_N: result = str_lit("N"); break;
        case OS_Key_O: result = str_lit("O"); break;
        case OS_Key_P: result = str_lit("P"); break;
        case OS_Key_Q: result = str_lit("Q"); break;
        case OS_Key_R: result = str_lit("R"); break;
        case OS_Key_S: result = str_lit("S"); break;
        case OS_Key_T: result = str_lit("T"); break;
        case OS_Key_U: result = str_lit("U"); break;
        case OS_Key_V: result = str_lit("V"); break;
        case OS_Key_W: result = str_lit("W"); break;
        case OS_Key_X: result = str_lit("X"); break;
        case OS_Key_Y: result = str_lit("Y"); break;
        case OS_Key_Z: result = str_lit("Z"); break;
        case OS_Key_0: result = str_lit("0"); break;
        case OS_Key_1: result = str_lit("1"); break;
        case OS_Key_2: result = str_lit("2"); break;
        case OS_Key_3: result = str_lit("3"); break;
        case OS_Key_4: result = str_lit("4"); break;
        case OS_Key_5: result = str_lit("5"); break;
        case OS_Key_6: result = str_lit("6"); break;
        case OS_Key_7: result = str_lit("7"); break;
        case OS_Key_8: result = str_lit("8"); break;
        case OS_Key_9: result = str_lit("9"); break;
        case OS_Key_Space: result = str_lit("Space"); break;
        case OS_Key_Enter: result = str_lit("Enter"); break;
        case OS_Key_Tab: result = str_lit("Tab"); break;
        case OS_Key_Esc: result = str_lit("Esc"); break;
        case OS_Key_Backspace: result = str_lit("Backspace"); break;
        case OS_Key_Delete: result = str_lit("Delete"); break;
        case OS_Key_Up: result = str_lit("Up"); break;
        case OS_Key_Down: result = str_lit("Down"); break;
        case OS_Key_Left: result = str_lit("Left"); break;
        case OS_Key_Right: result = str_lit("Right"); break;
...
os_key_from_codepoint(u32 codepoint, OS_Modifiers *modifiers)
{
    ...
    if (codepoint >= 'a' && codepoint <= 'z') {
        ...
        result = OS_Key_A + (codepoint - 'A');
        if (modifiers) *modifiers |= OS_Modifier_Shift;
    }
